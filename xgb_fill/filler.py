...
# from Bayes.Bayes_fill import BayesianTensorDecomposition
# from RF_fill.rf_fill import RF_fill_test
# from bi_xgb_time import XGB_fill_Forward,XGB_fill_Backward,Bi_XGBoost
from bi_xgb_space import XGB_fill_Forward,XGB_fill_Backward,Bi_XGBoost
...
class MissingDataTestingFramework:
    ...
    def evaluate_imputation(self):
        ...
        # imputed_data.to_csv(f'space_graph/3_bi.csv', index=True)
        # print(imputed_data)
        end_time = time.time()
...
if __name__ == "__main__":
    ...
    test_log.to_csv("xgb_space_bi.csv", index=0)
